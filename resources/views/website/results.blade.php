        ...
        <div class="row">
            <div class="col-md-10">
                <div class="post-category">
                    <h3 style="color: #c7254e;">Search Word : {{ $searchKey }}</h3>
                </div>
                <h1>Mel ut impetus suscipit tincidunt. Cum id ullum laboramus persequeris.</h1>
                <ul class="post-meta">
                    <li><a href="author.html">John Doe</a></li>
                    <li><i class="fa fa-comments"></i> 3</li>
                    <li><i class=""></i>Search Result : {{ $posts->count() }}</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @if($posts->count() == 0)
                    <p style="text-align: center; color: #c7254e">No posts for {{ $searchKey }}</p>
                @endif
